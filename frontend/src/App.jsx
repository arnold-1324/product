    ...
    <div className="container">
      ...
      <motion.div
        ...
        variants={{
          ...
          onscreen: { opacity: 1, y: 0, transition: { staggerChildren: 0.08, delayChildren: 0.1 } },
        }}
      >
        {products.map((product, index) => (
          <motion.div
            ...
            variants={{
              ...
              onscreen: { opacity: 1, y: 0, scale: 1, transition: { type: 'spring', stiffness: 400, damping: 24 } },
            }}
            whileHover={{ scale: 1.04, rotate: 2, boxShadow: '0 8px 24px rgba(46,139,87,0.18)' }}
          >
      ...
      <motion.form
        ...
        className="mt-12 max-w-lg mx-auto query-form"
        initial={{ opacity: 0, y: 40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        style={{ background: 'linear-gradient(135deg, #e0f7fa, #e8f5e9)', borderRadius: 20, boxShadow: '0 4px 16px rgba(46,139,87,0.10)' }}
      >
        ...
        <div className="mb-4 flex gap-4">
          <input
            ...
            name="name"
            placeholder="Name"
            className="flex-1 border border-gray-300 rounded-lg p-2 bg-white/80"
            value={form.name}
        ...
        <div className="mb-4">
          <textarea
            name="message"
            placeholder="Message"
            className="w-full border border-gray-300 rounded-lg p-2 bg-white/80 resize-none min-h-[120px] max-h-[200px]"
            value={form.message}
            onChange={handleChange}
            required
        ...
        {sent && <div className="text-green-700 font-semibold mt-2">Thank you! Your query has been sent.</div>}
      </motion.form>
